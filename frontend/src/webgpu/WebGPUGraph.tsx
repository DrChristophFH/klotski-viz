...
export const WebGPUGraph = forwardRef<WebGPUGraphRef, WebGPUGraphProps>(({
  ...
  useEffect(() => {
    ...
    console.log(`Load data effect: isInitialized=${isInitialized}, hasRenderer=${!!renderer}, hasData=${!!graphData}`);
    ...
    console.log(`Loading graph data: ${graphData.nodes.length} nodes, ${graphData.edges.length} edges`);
  ...
  return (
    <div style={{ position: 'relative', width, height }}>
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0 0 10px 0', fontSize: '16px' }}>Force Layout</h3>
        ...
        >
          ...
          <span style={{ fontSize: '12px' }}>{paramsExpanded ? '▼' : '▶'}</span>
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => handleRepulsionChange(parseFloat(e.target.value))}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => handleAttractionChange(parseFloat(e.target.value))}
            style={{ width: '100%', cursor: 'pointer' }}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            step="0.1"
            value={centerGravity}
            onChange={(e) => handleCenterGravityChange(parseFloat(e.target.value))}
            style={{ width: '100%', cursor: 'pointer' }}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            step="5"
            value={maxSpeed}
            onChange={(e) => handleMaxSpeedChange(parseFloat(e.target.value))}
            style={{ width: '100%', cursor: 'pointer' }}
          />
        </div>
